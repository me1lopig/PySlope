...
def main():
    ...
    with st.sidebar:
        ...
        st.divider()
        # --- NUEVA SECCIÓN DE CONTROL GRÁFICO ---
        ...
        if usar_limites:
            ...
            y_max = c6.number_input("Y Máx (m)", value=20.0, step=1.0)
        else:
    ...
    if st.button("Calcular Factor de Seguridad", type="primary"):
        ...
        try:
            ...
            # ==========================================
            # 5. CONTROL DE EJES Y DIMENSIONES (Tu petición)
            # ==========================================
            ...
            fig.update_layout(
                ...
                width=ancho_fig,   # <--- Control de Ancho
                height=alto_fig,   # <--- Control de Alto
                template="plotly_white",
                autosize=False     # Importante para respetar el tamaño fijo
            )
            ...
            if usar_limites:
                ...
                # Nota: Al forzar rangos manuales, la escala 1:1 puede perderse si 
                # la relación de aspecto de la ventana no coincide con los rangos.
                # Si quieres FORZAR 1:1 incluso con rangos manuales:
            ...
            # Usamos use_container_width=False para respetar los px exactos que pusiste
